...
public interface IWheelPicker {
     ...
     * 默认情况下滚轮选择器可见数据项数量为7
     *
     * <p>Set the count of current visible items in WheelPicker
     ...
     * 滚轮选择器数据项是否为循环状态.
     *
     * <p>Whether WheelPicker is cyclic or not
     *
     * @return 是否为循环状态
     */
    boolean isCyclic();
     ...
     *
     * <p>Set whether WheelPicker is cyclic or not
     ...
     *
     * <p>Get the position of current selected item in data source
     ...
     *
     * <p>Set the position of current selected item in data source
     ...
     * 获取数据列表.
     *
     * <p>Get data source of WheelPicker
     *
     * @return 数据列表
     */
    List<String> getData();
     ...
     *
     * <p>Set items of WheelPicker if has same width
     ...
     * 数据项是否有相同宽度.
     *
     * <p>Whether items has same width or not
     *
     * @return 是否有相同宽度
     */
     ...
     * 获取最宽的文本在数据源中的位置.
     *
     * <p>Get the position of maximum width text in data source
     *
     ...
     * 设置最宽的文本在数据源中的位置.
     *
     * <p>Set the position of maximum width text in data source
     *
     ...
     * 获取当前选中的数据项文本颜色.
     *
     * <p>Get text color of current selected item
     ...
     * 设置当前选中的数据项文本颜色.
     *
     * <p>Set text color of current selected item
     * For example 0xFF123456
     *
     ...
     *
     * <p>Set whether WheelPicker display indicator or not
     ...
     * 滚轮选择器是否有指示器.
     *
     * <p>Whether WheelPicker display indicator or not
     *
     * @return 滚轮选择器是否有指示器
     */
     ...
     *
     * <p>Set whether WheelPicker display curtain or not
     ...
     * 滚轮选择器是否显示幕布.
     *
     * <p>Whether WheelPicker display curtain or not
     *
     * @return 滚轮选择器是否显示幕布
     */
    boolean hasCurtain();
     ...
     *
     * <p>Set whether WheelPicker has atmospheric or not
     ...
     * 滚轮选择器是否有空气感.
     *
     * <p>Whether WheelPicker has atmospheric or not
     *
     * @return 滚轮选择器是否有空气感
     */
     ...
     * 滚轮选择器是否开启卷曲效果.
     *
     * <p>Whether WheelPicker enable curved effect or not
     *
     ...
     * 的视觉差距
     *
     * <p>Set whether WheelPicker enable curved effect or not
     ...
     * 获取滚轮选择器数据项的对齐方式.
     *
     * <p>Get alignment of WheelPicker
     *
     ...
     *
     * <p>Set alignment of WheelPicker
